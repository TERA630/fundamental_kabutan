...
- Technical Summary は B2 / B1 / A2 / A1 / A1弱 / C2 / C1 / D1 / D2 / D3 / E に分類する
- Technicalランクは状態分類、6M評価は新規エントリー推奨として別々に保持する
- 6M評価で終端位置を使うのは、25日線乖離率2〜4%帯の40%境界と8〜10%帯の50%境界だけとする
