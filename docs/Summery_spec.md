...
| 出来高比 | 当日出来高の20日平均比 |
| 崩れスコア | `崩れ {score}/9：{ラベル}`。score は崩れ警戒スコア、ラベルはランク別ラベル |
...
|---|---:|---:|---:|---:|---:|---:|---|---|---|---:|
| 信越工業(4063) | 6830円(-0.6%) | -8.8% | 6963-6743(3.2%:0.5ATR) | 6810円(+0.3%) | -8.0%(1.2ATR) | 120% | 崩れ 2/9：崩れ軽微 | PrevL:6743->20D-L:6682 | PrevH:6963->20D-H:7100 | 80% |
```
