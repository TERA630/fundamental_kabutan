...
- PERおよび配当利回りは、株探の行データに含まれる「修正1株益」「修正1株配当」を基準に算出する。
  ...
  - `PER = 株価 / 修正1株益`
  - `配当利回り(%) = 修正1株配当 / 株価 * 100`
- 表示する年数についての規定｡　取得できた最新一株配当{202x年}からその1年前､2年前の3年間を表示する｡　取得できた最新が2027年(予)であれば､2026年､2025年を表示することとなる｡
- 年の後の文言についての規定｡　取得できた一株配当が予想値なら202x年(予)､実績値なら202x年(実績)と表示する｡
