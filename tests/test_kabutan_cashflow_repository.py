...
def test_parse_kabutan_cashflow_rows_extracts_cash_stock_with_short_alias():
    html = """
    <table>
      <tr>
        <th>決算期</th><th>フリーCF<br>(百万円)</th><th>営業CF<br>(百万円)</th><th>投資CF<br>(百万円)</th><th>財務CF<br>(百万円)</th><th>現金等<br>(百万円)</th>
      </tr>
      <tr><th>2025.03</th><td>100</td><td>120</td><td>-20</td><td>10</td><td>300</td></tr>
    </table>
    """
...
def test_parse_kabutan_cashflow_rows_prefers_balance_column_when_change_and_balance_exist():
    html = """
    <table>
      <tr>
        <th>決算期</th><th>フリーCF<br>(百万円)</th><th>営業CF<br>(百万円)</th><th>投資CF<br>(百万円)</th><th>財務CF<br>(百万円)</th><th>現金等増減<br>(百万円)</th><th>現金等期末残高<br>(百万円)</th>
      </tr>
      <tr><th>2025.03</th><td>100</td><td>120</td><td>-20</td><td>10</td><td>50</td><td>300</td></tr>
    </table>
    """
...
def test_parse_kabutan_cashflow_rows_ignores_change_only_column_and_warns():
    html = """
    <table>
      <tr>
        <th>決算期</th><th>フリーCF<br>(百万円)</th><th>営業CF<br>(百万円)</th><th>投資CF<br>(百万円)</th><th>財務CF<br>(百万円)</th><th>現金等増減<br>(百万円)</th>
      </tr>
      <tr><th>2025.03</th><td>100</td><td>120</td><td>-20</td><td>10</td><td>50</td></tr>
    </table>
    """
